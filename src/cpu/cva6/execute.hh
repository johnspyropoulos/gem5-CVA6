...
#ifndef __CPU_CVA6_EXECUTE_HH__
#define __CPU_CVA6_EXECUTE_HH__
...
class Execute : public Named
{
  protected:
     ...
     *  which pass the CVA6DynInst::isNoCostInst test */
  ...
  protected:
    ...
    struct ExecuteThreadInfo
    {
         ...
         *  Increment this and pass to fetch whenever an instruction
         *  stream needs to be changed.
        ...
        /** State progression for
         * draining NotDraining -> ... -> DrainAllInsts */
  ...
  protected:
    ...
    void updateBranchData(ThreadID tid, BranchData::Reason reason,
        CVA6DynInstPtr inst, const PCStateBase &target, BranchData &branch);
    ...
    void handleMemResponse(CVA6DynInstPtr inst,
    ...
    bool executeMemRefInst(CVA6DynInstPtr inst, BranchData &branch,
    ...
    bool commitInst(CVA6DynInstPtr inst, bool early_memory_issue,
  ...
  public:
    ...
    CVA6CPU::CVA6CPUPort &getDcachePort();
