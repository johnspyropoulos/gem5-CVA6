...
#ifndef __CPU_CVA6_FETCH1_HH__
#define __CPU_CVA6_FETCH1_HH__
...
class Fetch1 : public Named
{
  ...
  protected:
    ...
    struct Fetch1ThreadInfo
    {
         ...
         *  or Fetch2 ask for a change of fetch address and is used to tag
         *  lines by the prediction to which they belong.  Fetch2 originates
  ...
  protected:
    ...
    void cva6TraceResponseLine(const std::string &name,
