...
#ifndef __CPU_CVA6_PIPE_DATA_HH__
#define __CPU_CVA6_PIPE_DATA_HH__
...
class BranchData /* : public ReportIF, public BubbleIF */
{
  ...
  public:
    ...
    BranchData(Reason reason_, ThreadID thread_id,
            ...
            const PCStateBase &_target, CVA6DynInstPtr inst_) :
...
class ForwardInstData /* : public ReportIF, public BubbleIF */
{
  public:
    ...
    CVA6DynInstPtr insts[MAX_FORWARD_INSTS];
...
#endif /* __CPU_CVA6_PIPE_DATA_HH__ */
