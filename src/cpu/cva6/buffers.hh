#ifndef __CPU_CVA6_BUFFERS_HH__
#define __CPU_CVA6_BUFFERS_HH__
...
/** TimeBuffer with CVA6Trace and Named interfaces */
template <typename ElemType,
...
class CVA6Buffer : public Named, public TimeBuffer<ElemType>
{
  protected:
    ...
    /** Name to use for the data in a CVA6Trace line */
    std::string dataName;
...
class Latch
{
  ...
  public:
    ...
    void cva6Trace() const { buffer.cva6Trace(); }
...
class Queue : public Named, public Reservable
{
  private:
    ...
    /** Name to use for the data in CVA6Trace */
    std::string dataName;
