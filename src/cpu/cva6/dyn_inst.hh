...
#ifndef __CPU_CVA6_DYN_INST_HH__
#define __CPU_CVA6_DYN_INST_HH__
 ...
 *  exec with exec absent if it is 0.  This is used by CVA6Trace. */
std::ostream &operator <<(std::ostream &os, const CVA6DynInst &inst);

/** Dynamic instruction for CVA6.
 *  CVA6DynInst implements the BubbleIF interface
...
class CVA6DynInst : public RefCounted
{
  ...
  public:
    CVA6DynInst(StaticInstPtr si, InstId id_=InstId(), Fault fault_=NoFault) :
  ...
  public:
     ...
     *  CVA6Trace using the given Named object's name */
    void cva6TraceInst(const Named &named_object) const;
...
#endif /* __CPU_CVA6_DYN_INST_HH__ */
