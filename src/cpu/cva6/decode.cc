...
static void
dynInstAddTracing(CVA6DynInstPtr inst, StaticInstPtr static_inst,
    CVA6CPU &cpu)
{
...
Decode::evaluate()
{
    ...
    if (tid != InvalidThreadID) {
        ...
        {
            CVA6DynInstPtr inst = insts_in->insts[decode_info.inputIndex];
            ...
            if (inst->isBubble()) {
                ...
                if (inst->isFault()) {
                    ...
                    output_inst =
                        new CVA6DynInst(static_micro_inst, inst->id);
