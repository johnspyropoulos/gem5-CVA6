...
#ifndef __CPU_CVA6_NEW_LSQ_HH__
#define __CPU_CVA6_NEW_LSQ_HH__
...
class LSQ : public Named
{
  ...
  protected:
    ...
    /** Exposable data port */
    class DcachePort : public CVA6CPU::CVA6CPUPort
    {
      protected:
        /** My owner */
        LSQ &lsq;
      ...
      public:
        DcachePort(std::string name, LSQ &lsq_, CVA6CPU &cpu) :
            CVA6CPU::CVA6CPUPort(name, cpu), lsq(lsq_)
        { }
  ...
  public:
        ...
        public Packet::SenderState /* For packing into a Packet */
    {
      ...
      public:
        LSQRequest(LSQ &port_, CVA6DynInstPtr inst_, bool isLoad_,
  ...
  protected:
    ...
    class SpecialDataRequest : public LSQRequest
    {
      ...
      public:
        SpecialDataRequest(LSQ &port_, CVA6DynInstPtr inst_) :
    ...
    {
      public:
        FailedDataRequest(LSQ &port_, CVA6DynInstPtr inst_) :
    ...
    class BarrierDataRequest : public SpecialDataRequest
    {
      ...
      public:
        BarrierDataRequest(LSQ &port_, CVA6DynInstPtr inst_) :
            SpecialDataRequest(port_, inst_)
        { state = Complete; }
    };
    ...
    class SingleDataRequest : public LSQRequest
    {
      ...
      public:
        SingleDataRequest(LSQ &port_, CVA6DynInstPtr inst_,
    ...
    class SplitDataRequest : public LSQRequest
    {
      ...
      public:
        SplitDataRequest(LSQ &port_, CVA6DynInstPtr inst_,
    ...
    class StoreBuffer : public Named
    {
      ...
      public:
        ...
        /** Report queue contents for CVA6Trace */
  ...
  protected:
    ...
    void clearMemBarrier(CVA6DynInstPtr inst);
  ...
  public:
    ...
    LSQRequestPtr findResponse(CVA6DynInstPtr inst);
     ...
     *  committed */
    void issuedMemBarrierInst(CVA6DynInstPtr inst);
    ...
    void completeMemBarrierInst(CVA6DynInstPtr inst,
        bool committed);

    /** Single interface for readMem/writeMem/amoMem to issue requests into
     *  the LSQ */
    Fault pushRequest(CVA6DynInstPtr inst, bool isLoad, uint8_t *data,
    ...
    void pushFailedRequest(CVA6DynInstPtr inst);
    ...
    CVA6CPU::CVA6CPUPort &getDcachePort() { return dcachePort; }
